...
const generateConfig = env => {
    return {
        ...
        plugins: [
            ...
            new HtmlWebpackPlugin(getHtmlConfig('04', '烟雾水云效果', env)),
            new HtmlWebpackPlugin(getHtmlConfig('05', '使用官方提供的水模型', env)),
            new HtmlWebpackPlugin(getHtmlConfig('06', '着色器点材质打造渐变星系', env)),
